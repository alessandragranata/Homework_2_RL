...
def generate_launch_description():
    ...
    declared_arguments.append(DeclareLaunchArgument('gz_args', default_value=PathJoinSubstitution([FindPackageShare('iiwa_description'),'gazebo/worlds/empty.world.sdf']),
